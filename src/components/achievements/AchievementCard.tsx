    ...
    >
      ...
      {achievement.unlocked && (
        <motion.div
          ...
          className="absolute top-2 right-2 bg-green-500 text-white text-xs font-bold w-6 h-6 rounded-full shadow-lg z-10 border-2 border-white flex items-center justify-center"
        >
          ✓
        </motion.div>
      )}
